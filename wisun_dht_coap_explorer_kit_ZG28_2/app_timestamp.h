...
#ifdef SEGGER_RTT_H
#define printfRTT(...)                                         \
    snprintf(timestamped_msg, TIMESTAMP_MSG_LEN, __VA_ARGS__); \
    SEGGER_RTT_printf(0, timestamped_msg)
#define printfTimeRTT(...)                                     \
    snprintf(timestamped_msg, TIMESTAMP_MSG_LEN, __VA_ARGS__); \
    SEGGER_RTT_printf(0, "[%s] %s", now_str(), timestamped_msg)
#define printfBoth(...)                                        \
    snprintf(timestamped_msg, TIMESTAMP_MSG_LEN, __VA_ARGS__); \
    SEGGER_RTT_printf(0, timestamped_msg);                     \
    printf(timestamped_msg)
#define printfBothTime(...)                                      \
    snprintf(timestamped_msg, TIMESTAMP_MSG_LEN, __VA_ARGS__);   \
    SEGGER_RTT_printf(0, "[%s] %s", now_str(), timestamped_msg); \
    printf("[%s] %s", now_str(), timestamped_msg)
#else /* SEGGER_RTT_H */
